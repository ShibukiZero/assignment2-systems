...
OUTPUT_DIR=".agents/logs/1_2_2_torch_compile"
WARMUP_STEPS=5
MEASURE_STEPS=100
BATCH_SIZE=8
DEVICE="cuda"
...
usage() {
  cat <<'EOF'
Usage:
  bash scripts/run_1_2_2_torch_compile_sweep.sh [options]
...
Examples:
  bash scripts/run_1_2_2_torch_compile_sweep.sh
  bash scripts/run_1_2_2_torch_compile_sweep.sh --dims "64 128" --sequence-lengths "4096 8192 16384"
  bash scripts/run_1_2_2_torch_compile_sweep.sh --implementations "eager compiled" --causal
EOF
}
